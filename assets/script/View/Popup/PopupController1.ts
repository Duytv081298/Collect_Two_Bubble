...
import ForfeitAttack from "./Forfeit attack/ForfeitAttack";
...
@ccclass
export default class PopupController1 extends cc.Component {
    ...
    loadForfeitAttack(data:any = {isAttack:true, sameContext:false}) {
    ...
    showForfeitAttack(data:any) {
        ...
        if (this.forfeitAttack != null) {
            ...
            this.forfeitAttack.getComponent(ForfeitAttack).show(data);
        } else {
            this.showLoading();
            this.ktShowForfeitAttack = true;
            this.loadForfeitAttack(data);
        }
    }
    hideLoading() {
