  ...
  player: {
    ...
    getPhoto: function () {      
      ...
      if (isFirefox)
        ...
        name = "https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=1476475846162839&gaming_photo_type=unified_picture&ext=1672466734&hash=AeTbxb8HDDfHqg-tlQs";
      return FBInstant.__utils.returnUserData(name);
    },
    getID: function () {
    ...
    loadBannerAdAsync: function () {
      return new Promise(function (resolve, reject) {
        reject(new Error('loadBannerAdAsync failed'));
      });
    },
    ...
    getConnectedPlayersAsync: function () {
      return new Promise(function (resolve, reject) {
        ...
        if (initialized) {
          if (FBInstant.player.getID() == "4005052392952647") {
            players = [{
              getID: function () {
                return '4936216286483643';
              },
              getName: function () {
                return 'Duy Tom';
              },
              getPhoto: function () {
                return "https://platform-lookaside.fbsbx.com/platform/instantgames/profile_pic.jpg?igpid=4936216286483643&height=256&width=256&ext=1660959689&hash=AeRSQ1bIExLEcurOWb0";
              }
            },{
              getID: function () {
                return '4936216286483643';
            ...
            players = [{
              getID: function () {
                return '4005052392952647';
              },
              getName: function () {
                return 'Linh';
              },
              getPhoto: function () {
                return "https://platform-lookaside.fbsbx.com/platform/instantgames/profile_pic.jpg?igpid=4005052392952647&height=256&width=256&ext=1660382560&hash=AeS5e0fNRnY_Jm9Uu9o";
              }
            }];
          }
        } else {
        ...
        var signedPlayerInfo = {
          getSignature: function () {
            ...
            if (isFirefox)
              ...
              playerId = "Nv3X3-sLHlhEeRWjzEk4ITxHhT1WY2bV9mYhJBMpmdg.eyJhbGdvcml0aG0iOiJITUFDLVNIQTI1NiIsImlzc3VlZF9hdCI6MTY2OTg3NDczNCwicGxheWVyX2lkIjoiNTY3NDU2MjQ0OTMwNDQwNCIsInJlcXVlc3RfcGF5bG9hZCI6bnVsbH0";
            return playerId;
          },
